...
jQuery(function ($) {
    ...
    var InsertFields = [];
    $.each($('.produkt_zutat').parent().parent(), function(){
        var parent = $(this);
        var child = parent.find('.produkt_zutat');
        var selected = parent.find('.produkt_einheiten').val();
    ...
    function getNewEinheitenAjax(html, id, selected = ""){
        ...
        $.ajax({
            ...
            success: function (data) {
                var selectField = html.find('.produkt_einheiten');

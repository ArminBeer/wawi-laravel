<x-app-layout>
    <x-slot name="header">
        ...
        <div class="font-semibold text-xl text-gray-800 leading-tight">
            @if ($type == 1)
            {{ __('Gericht erstellen') }}
            @elseif ($type == 2)
                {{ __('Bar Angebot erstellen') }}
            @elseif ($type == 3)
                {{ __('Eis Angebot erstellen') }}
            @else
                {{ __('Gericht erstellen') }}
            @endif
        </div>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm">
                <div class="p-6 bg-white border-b border-gray-200">
                    {!! Form::open(['action' => ['RezeptController@store', $type], 'method' => 'POST', 'files' => true]) !!}
                    @csrf
                    @method('PUT')
                    <div class="table w-full">
                        <div class="table-row-group">
                            <div class="table-row font-bold">
                                {{Form::label('rezept_name_label', 'Name')}}
                            </div>
                            <div class="table-row">
                                {{Form::text('rezept_name', null, ['class' => 'w-full h-12 px-4 mb-2 text-lg text-gray-700 placeholder-gray-600 border', 'placeholder' => 'Name des Gerichts'])}}
                            </div>
                        </div>
                        ...
                        <div class="flex flex-col border-solid border-indigo-800 border-2 sm:rounded-lg mb-5">
                            ...
                            <div class="flex justify-between px-5 pt-5">
                                ...
                                <div class="w-full flex justify-around">
                                    <div>
                                        {{Form::checkbox('restaurant', 1, 0, ['class ' => 'h-5 w-5 text-blue-600']) }}
                                        {{Form::label('business_label', 'Restaurant', ['class' => 'font-bold'])}}
                                    </div>
                                    <div>
                                        {{Form::checkbox('eis', 1, 0, ['class ' => 'h-5 w-5 text-blue-600']) }}
                            ...
                            <div class="table-row-group p-5">
                                ...
                                <div class="grid grid-cols-1 gap-4">
                                    <div class="col-span-1">
                                        {{Form::select('sku', [null => 'Bitte wählen'] + $articles, null, ['class' => 'w-full px-4 mb-2 text-lg text-gray-700 placeholder-gray-600 border focus:shadow-outline select-2'])}}
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="table-row-group">
                            ...
                            <div class="table-row">
                                {{Form::textarea('description_short', null, ['class' => 'w-full px-4 mb-2 text-lg text-gray-700 placeholder-gray-600 border', 'placeholder' => 'Kurzbeschreibung'])}}
                            </div>
                        </div>
                        <div class="table-row-group">
                            <div class="table-row font-bold">
                            ...
                            <div class="table-row">
                                {{Form::textarea('description_long', null, ['class' => 'w-full px-4 mb-2 text-lg text-gray-700 placeholder-gray-600 border', 'placeholder' => 'Ausführliche Anleitung'])}}
                            </div>
                        </div>
                        <!-- Add Zutaten -->
                                ...
                                <div class="grid grid-cols-12 gap-4">
                                    <div class="col-span-10 grid grid-cols-10 gap-4 zutat-delete" id="zutat_form">
                                        <div class="col-span-3 zutat_element">
                                            {{Form::select('zutaten[]',[null => 'Bitte wählen'] + $zutaten, null, ['class' => 'rezept_zutat w-full px-4 mb-2 text-lg text-gray-700 placeholder-gray-600 border  focus:shadow-outline select-2'])}}
                                        </div>
                                        <div class="col-span-3 zutat_element">
                                            {{Form::number('zutat_mengen[]', null, ['step' => 'any', 'class' => 'w-full h-12 px-4 mb-2 text-lg text-gray-700 placeholder-gray-600 border border-gray-700 focus:shadow-outline', 'placeholder' => 'Menge'])}}
                                        </div>
                                        <div class="col-span-2 zutat_element">
                                            {{Form::select('zutat_einheiten[]',[null => 'Bitte wählen'] + $einheiten, null, ['class' => 'w-full px-4 mb-2 text-lg text-gray-700 placeholder-gray-600 border  focus:shadow-outline rezept_einheiten'])}}
                                        </div>
                                        <div class="col-span-2 zutat_element">

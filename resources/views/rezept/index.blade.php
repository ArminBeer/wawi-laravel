<x-app-layout>
    <x-slot name="header">
        ...
        @if(Auth::user()->kitchen_edit_right)
            <x-nav-link :href="route('rezepte.create', ['type' => $type])" class="inline-flex items-center h-10 px-5 bg-strizzi">
                ...
                <div class="wun-card-wrapper flex flex-wrap">
                    @if (count($rezepte) > 0)
                        @foreach ($rezepte as $rezept)
                            <div class="wun-card">
                                <a class="wun-card-link" href="{{ route('rezepte.show', ['rezepte' => $rezept['id']]) }}">
                                    @if ($rezept['picture'] != null)
                                        <div class="wun-card-image" style="background-image:url(/storage{{ $rezept['picture'] }})" loading="lazy"></div>
                                    @else
                                ...
                                <div class="wun-card-buttons">
                                    <a href="{{ route('rezepte.order', ['rezepte' => $rezept['id']]) }}" class="wun-card-order">
                                        <span class="text-white">{{ __('Order') }}</span>
                                        <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                            viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;" xml:space="preserve"><g><g><path d="M458.732,422.212l-22.862-288.109c-1.419-18.563-17.124-33.098-35.737-33.098h-45.164v66.917
                                                ...
                                                s68.976,30.949,68.976,68.986v2.029h29.989v-2.029C354.969,44.404,310.575,0,256.004,0z"/></g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g></svg>
                                    </a>
                                </div>
                            </div>
                        @endforeach

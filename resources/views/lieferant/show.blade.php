<x-app-layout>
    <x-slot name="header">
        ...
        <div class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Lieferant:') }} {{ $lieferant['name'] }}
        </div>
        <a href="{{ route('lieferanten.edit', ['lieferanten' => $lieferant['id']]) }}" class="inline-flex items-center h-10 px-5 text-white bg-gray-800">
            <span>{{ __('Bearbeiten') }}</span>
                        ...
                        <div class="shadow overflow-hidden border-b border-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm text-gray-900">{{ $lieferant['strasse'] }}<br />{{ $lieferant['plz'] }} {{$lieferant['ort']}}<br />{{$lieferant['land']}}</div>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
